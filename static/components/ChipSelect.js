...
function Option(props) {
  return (
    ...
    <MenuItem
      ...
      {...props.innerProps}
    >
      <Avatar  alt="Natacha" src={props.data.author.img} style={{marginRight: '10'}}></Avatar>
      {props.children}
    </MenuItem>
  );
}
...
function MultiValue(props) {
  return (
    ...
    <Chip
      ...
      // label={JSON.stringify(Object.keys(props),null,'\t')}
      avatar={<Avatar alt="Natacha" src={props.data.author.img}></Avatar>}
     ...
     .then(response => 
       //TODO: initialize loading here
         response.json().then(post=> {
          ...
          var newAuthors = post.map( (author, index) => { 
            return { 
              label: author.name,
              // value: index,
               value: author.id,
