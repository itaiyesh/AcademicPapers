...
const RouteWithLayout = props => {
  ...
  const { layout: Layout, component: Component, searchQuery, setSearchQuery, onSearchQueryResults, onAuthorSelected, recommendedAuthors, setRecommendedAuthors, author, ...rest } = props;
  ...
  return (
    <Route
      ...
      render={ matchProps => 
        (
        <Layout onSearchQueryResults={onSearchQueryResults} searchQuery={searchQuery} setSearchQuery={setSearchQuery}>
